...
const WithdrawlModal = ({onClose}) => {
  ...
  return (
    <div className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity z-[100] flex items-center justify-center sm:p-4'>
        <div className='bg-white sm:rounded-lg shadow-2xl w-full max-w-lg h-screen sm:h-auto flex flex-col'>
            ...
            {/* Form  */}
            <form onSubmit={handlesub} className='flex flex-col items-start gap-4 p-4 overflow-y-scroll'>
